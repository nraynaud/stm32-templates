                               ...
                               USB_SETUP_REQ *req)
{
  ...
  case USB_DESC_TYPE_DEVICE_QUALIFIER:                   
    ...
    if(pdev->cfg.speed == USB_OTG_SPEED_HIGH  )   
    {
      ...
      pbuf   = pdev->dev.usr_device->GetDeviceDescriptor(pdev->cfg.speed, &len);
      USBD_DeviceQualifierDesc[0] = USB_LEN_DEV_QUALIFIER_DESC;
      USBD_DeviceQualifierDesc[1] = USB_DESC_TYPE_DEVICE_QUALIFIER;
      USBD_DeviceQualifierDesc[2] = pbuf[2];
      USBD_DeviceQualifierDesc[3] = pbuf[3];
      USBD_DeviceQualifierDesc[7]= pbuf[7];
      USBD_DeviceQualifierDesc[8]= pbuf[17];
      USBD_DeviceQualifierDesc[9]= 0;
